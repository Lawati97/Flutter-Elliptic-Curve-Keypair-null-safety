...
class FlutterEllipticCurveKeyPair {
  static const MethodChannel _channel = const MethodChannel('flutter_elliptic_curve_keypair');
  ...
  static Future<EccResultModel> ellipticCurveKeyPairSigning(
    //This was changed required was added
      {required String message,required String language,required String alias}) async {
    Map arguments = {
      "message": message,
      "language": language,
      "alias": alias,
    ...
    try {
      ...
      EccResultModel platformException = EccResultModel(
        data: e.details,
        success: false,
        description: e.message.toString(), //This was changed .toString() was added
      );
